...
if __name__ == '__main__':
    ...
    for a in range(26):
        ...
        percentage = checkenglishness.countngram(checkenglishness.removespace(text_decrypted), 2, checkenglishness.bigrams)
        print(round(checkenglishness.checkenglishnes(percentage, checkenglishness.bigrams), 2), end='')
        print(percentage)
    # #ax+b
    ...
    # for a in a_possible:
    #     for b in range(26):
    #         text_decrypted = get_map_of_ax_plus_b(a, b)
    #         percentage = checkenglishness.countngram(checkenglishness.removespace(text_decrypted), 2,checkenglishness.bigrams)